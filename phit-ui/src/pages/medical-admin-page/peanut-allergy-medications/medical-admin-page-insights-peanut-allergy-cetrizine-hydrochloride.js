...
const MedicalAdminPageInsightsPeanutAllergyCetrizineHydrochloride = () => {
     const [data, setData] = React.useState(null);
      React.useEffect(() => {
         fetch("/cetirizinePeanut")
             .then((res) => res.json())
    ...
    return (<div className="medical-admin">
        ...
        <div>
            <div className="medical-admin-insights-title">
                Cetrizine Hydrochloride Predictions
            </div>
...
export default MedicalAdminPageInsightsPeanutAllergyCetrizineHydrochloride;
