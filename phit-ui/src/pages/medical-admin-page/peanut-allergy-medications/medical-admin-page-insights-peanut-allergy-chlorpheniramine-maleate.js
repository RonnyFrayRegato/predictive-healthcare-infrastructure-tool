...
const MedicalAdminPageInsightsPeanutAllergyChlorpheniramineMaleate = () => {
     const [data, setData] = React.useState(null);
      React.useEffect(() => {
         fetch("/chlorpheniraminePeanut")
             .then((res) => res.json())
    ...
    return (<div className="medical-admin">
        ...
        <div>
            <div className="medical-admin-insights-title">
                Chlorpheniramine Maleate Predictions
            </div>
...
export default MedicalAdminPageInsightsPeanutAllergyChlorpheniramineMaleate;
