...
const MedicalAdminPageInsightsPeanutAllergyEpinephrine = () => {
     const [data, setData] = React.useState(null);
      React.useEffect(() => {
         fetch("/epinephrinePeanut")
             .then((res) => res.json())
...
export default MedicalAdminPageInsightsPeanutAllergyEpinephrine;
