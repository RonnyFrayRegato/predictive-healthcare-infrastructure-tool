...
const MedicalAdminPageInsightsPeanutAllergyFexofenadineHydrochloride = () => {
     const [data, setData] = React.useState(null);
      React.useEffect(() => {
         fetch("/fexofenadinePeanut")
             .then((res) => res.json())
    ...
    return (<div className="medical-admin">
        ...
        <div>
            <div className="medical-admin-insights-title">
                Fexofenadine Hydrochloride Predictions
            </div>
...
export default MedicalAdminPageInsightsPeanutAllergyFexofenadineHydrochloride;
