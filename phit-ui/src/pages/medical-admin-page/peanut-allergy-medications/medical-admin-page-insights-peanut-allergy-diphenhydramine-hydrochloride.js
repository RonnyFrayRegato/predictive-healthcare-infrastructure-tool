...
const MedicalAdminPageInsightsPeanutAllergyDiphenhydramineHydrochloride = () => {
     const [data, setData] = React.useState(null);
      React.useEffect(() => {
         fetch("/diphenhydraminePeanut")
             .then((res) => res.json())
...
export default MedicalAdminPageInsightsPeanutAllergyDiphenhydramineHydrochloride;
