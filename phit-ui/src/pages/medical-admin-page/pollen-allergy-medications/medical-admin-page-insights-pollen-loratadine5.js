...
const MedicalAdminPageInsightsPollenLoratadine5  = () => {
     const [data, setData] = React.useState(null);
      React.useEffect(() => {
         fetch("/loratadineFivePollen")
             .then((res) => res.json())
...
export default MedicalAdminPageInsightsPollenLoratadine5;
