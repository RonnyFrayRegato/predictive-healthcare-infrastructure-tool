...
const MedicalAdminPageInsightsPollenEpinephrine1 = () => {
     const [data, setData] = React.useState(null);
      React.useEffect(() => {
         fetch("/epinephrinePollen")
             .then((res) => res.json())
...
export default MedicalAdminPageInsightsPollenEpinephrine1;
