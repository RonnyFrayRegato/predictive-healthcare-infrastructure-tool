...
const MedicalAdminPageInsightsPollenLoratadine10  = () => {
     const [data, setData] = React.useState(null);
      React.useEffect(() => {
         fetch("/loratadineTenPollen")
             .then((res) => res.json())
...
export default MedicalAdminPageInsightsPollenLoratadine10;
