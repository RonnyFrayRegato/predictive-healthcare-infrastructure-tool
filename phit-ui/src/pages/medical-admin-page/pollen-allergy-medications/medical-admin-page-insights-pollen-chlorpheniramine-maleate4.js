...
const MedicalAdminPageInsightsPollenChlorpheniramineMaleate4 = () => {
     const [data, setData] = React.useState(null);
      React.useEffect(() => {
         fetch("/chlorpheniramineFourPollen")
             .then((res) => res.json())
    ...
    return (<div className="medical-admin">
        ...
        <div>
            <div className="medical-admin-insights-title">
                Chlorpheniramine Maleate 4 MG Predictions
            </div>
...
export default MedicalAdminPageInsightsPollenChlorpheniramineMaleate4;
