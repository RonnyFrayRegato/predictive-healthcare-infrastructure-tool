...
const MedicalAdminPageInsightsPollenTerfenadine60 = () => {
     const [data, setData] = React.useState(null);
      React.useEffect(() => {
         fetch("/terfenadinePollen")
             .then((res) => res.json())
...
export default MedicalAdminPageInsightsPollenTerfenadine60;
