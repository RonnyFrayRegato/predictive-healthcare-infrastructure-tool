...
const MedicalAdminPageInsightsPollenCetirizineHydrochloride5 = () => {
    const [data, setData] = React.useState(null);
    React.useEffect(() => {
        fetch("/cetirizineFivePollen")
            .then((res) => res.json())
    ...
    return (<div className="medical-admin">
        ...
        <div>
            <div className="medical-admin-insights-title">
                Cetirizine Hydrochloride 5 MG Predictions
            </div>
...
export default MedicalAdminPageInsightsPollenCetirizineHydrochloride5;
